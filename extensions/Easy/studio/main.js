...
const Properties = props => /*#__PURE__*/React.createElement("div", {
  className: "properties-section"
}, /*#__PURE__*/React.createElement("div", {
  className: "form-group"
}, /*#__PURE__*/React.createElement("label", null, "custom content"), /*#__PURE__*/React.createElement("input", {
  type: "text",
  placeholder: "a custom string",
  value: props.entity.custom,
  onChange: v => props.onChange({
    custom: v.target.value,
    _id: props.entity._id
  })
})));
jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().addPropertiesComponent('custom', Properties, entity => entity.__entitySet === 'templates');
...
jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().readyListeners.push(async () => {
  ...
  jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().openModal(() => /*#__PURE__*/React.createElement("span", null, "Hello from the custom easy extension"));
});
})();
